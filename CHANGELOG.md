...
### Added
- feat(nano-brain): sync v3.2.0 → v5.0.0

**Install:** `npm install @nano-step/skill-manager@5.26.0`
...
### Added
- feat(nano-brain): sync v3.1.0 → v3.2.0

**Install:** `npm install @nano-step/skill-manager@5.25.0`
